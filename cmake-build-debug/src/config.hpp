...
// Fetch the directory for document files
    ...
    const std::string APP_DIR = HOME + "/Library/Application Support/cgintro-animation/"; // Writing into the .app bundle is not allowed as it is signed
#else
    const std::string APP_DIR = ""; // On other platforms just write into the application directory
#endif
const std::string PROJECT_NAME = "cgintro-animation";
const std::string SHADER_DIR = "shaders/";
const std::string COMPOSED_SHADER_DIR = "/home/timnogga/CLionProjects/cg-animation/composed/";
...
inline void setWorkingDirectory() {
        ...
        const std::filesystem::path RES_DIR{"/home/timnogga/CLionProjects/cg-animation"};
